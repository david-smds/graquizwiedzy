...
struct QuizBrainLong {
    ...
    let quiz = [
        ...
        Question(q: "Czym jest deuter?", a: ["Izotopem wodoru", "Gazem szlachetnym", "Materiałem wybuchowym"], correctAnswer: "Izotopem wodoru"),
        ...
        Question(q: "Jak nazywają się największe małpy zwierzokształtne?", a: ["Makaki", "Mandryle", "Orangutany"], correctAnswer: "Mandryle"),
    ...
    mutating func resetGameQuestion() {
        if getMistake() >= 3  {
            questionNumber = Int(arc4random_uniform(530))//Int.random(in: 0...30)
            score = 0
            mistakes = 0
            questionAsked = 0
